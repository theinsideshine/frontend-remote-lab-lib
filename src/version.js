// v1.0.04 Se agrego soporte para experimentos de ejemplo 2
// v1.0.05 Se agrego pag about
//         Se cambio result_x por resultx
//         Se agrego example 3 y 4
// v1.0.06 Se agrego cfg de ip por archivo
